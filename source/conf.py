...
latex_documents = [
    (master_doc, 'pixel.tex', 'pixel+ Documentation',
     'Vincent Vanweddingen', 'manual'),
]
...
man_pages = [
    (master_doc, 'pixel', 'pixel+ Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pixel', 'pixel+ Documentation',
     author, 'pixel', 'One line description of project.',
     'Miscellaneous'),
]
...
pdf_documents = [('index', u'rst2pdf', u'Pixel+', u'Vincent Vanweddingen'),]
