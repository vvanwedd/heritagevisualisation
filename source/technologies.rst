...
=========================
Plenty of methods exist to reconstruct a 3D representation of cultural artefacts. Depending on the used technology, some methods work better on objects with certain shapes and materials than others. Most of the time, these algorithms have lots of parameters that the user should set to obtain optimal results. Software packages like Agisoft Metashape typically combine several (tweaked) algorithms.
